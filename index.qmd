...
avgReadingMasterss<-ReadingByEducation %>% filter(`parental level of education` == "master's degree") %>% pull(avg_reading_score)
avgWritingMasterss<-WritingByEducation %>% filter(`parental level of education` == "master's degree") %>% pull(avg_writing_score)
